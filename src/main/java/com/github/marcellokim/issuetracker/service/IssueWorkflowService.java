...
// import
// com.github.marcellokim.issuetracker.repository.IssueDependencyRepository;
...
// public IssueWorkflowActions viewAvailableActions(long issueId, String
// currentUserId) {
...
// boolean canManageAssignment = projectLead &&
// permissionPolicy.canAssignIssue(actor, issue);
// boolean canManageDependency = projectLead &&
// permissionPolicy.canManageDependency(actor, issue);
// boolean canCloseOrReopen = projectLead;
// boolean canManageDeleted = projectLead &&
// permissionPolicy.canManageDeletedIssue(actor, issue);
...
// public boolean canUpdateComment(long issueId, long commentId, String
// currentUserId) {
// Issue issue = findIssue(issueId);
...
// public boolean canDeleteComment(long issueId, long commentId, String
// currentUserId) {
// Issue issue = findIssue(issueId);
// Comment comment = findComment(commentId);
// User actor = findUser(currentUserId);
...
// for (IssueDependency dependency :
...
// private static boolean isOneOf(Issue issue, IssueStatus first, IssueStatus
// second) {
