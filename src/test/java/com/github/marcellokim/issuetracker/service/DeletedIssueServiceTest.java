...
class DeletedIssueServiceTest {
        ...
        private final User reporter = User.fromPersistence("tester1", "Tester One", "hash", Role.TESTER, true, NOW,
                        NOW);
        ...
        private Issue issueWithStatus(IssueStatus status) {
                return Issue.fromPersistence(
                                Issue.persistedState(PROJECT_ID, "Deleted issue", "Deleted description", reporter)
                                                .id(ISSUE_ID)
                                                .issueId("ISSUE-1")
                                                .reportedDate(NOW)
        ...
        private final class FakeDeletedIssueRepository implements DeletedIssueRepository {
                ...
                private FakeDeletedIssueRepository(Issue... deletedIssues) {
                        this.deletedIssues = List.of(deletedIssues);
                }
                ...
                @Override
                public Issue softDelete(Issue issue, String changedById, String message,
                ...
                @Override
                public Issue restore(Issue issue, String changedById, String message,
                                LocalDateTime changedDate) {
                        lastMessage = message;
                ...
                private Issue copyWithStatus(Issue issue, IssueStatus status, LocalDateTime updatedAt) {
                        return Issue.fromPersistence(Issue
                                        .persistedState(issue.projectId(), issue.title(), issue.description(),
                                                        issue.getReporter())
                                        .id(issue.id())
