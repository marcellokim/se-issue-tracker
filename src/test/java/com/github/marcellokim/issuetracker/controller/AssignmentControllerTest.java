...
class AssignmentControllerTest {
    ...
    void startsAssignment() {
        ...
        var issues = new ControllerTestSupport.FakeIssueRepository(issue, completedIssue);
        var recommendations = new ControllerTestSupport.FakeAssignmentRecommendationRepository();
    ...
    void startNeedsLoginAndIssue() {
        ...
        AssignmentRecommendationService recommendations = new AssignmentRecommendationService(
                new ControllerTestSupport.FakeAssignmentRecommendationRepository(), new KNNAssignmentRecommendation());
        ...
        AssignmentController plController = new AssignmentController(
                ...
                new com.github.marcellokim.issuetracker.service.AssignmentService(
                        new ControllerTestSupport.FakeIssueRepository(),
                        new ControllerTestSupport.FakeUserRepository(),
                        policy,
                        recommendations,
                        java.time.LocalDateTime::now));
