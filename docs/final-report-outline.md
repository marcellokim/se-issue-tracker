...
| 9. 협업 및 프로젝트 관리 | GitHub Project, issue/PR/review 흐름, 마일스톤 진행 근거 | 4 |
...
2. GitHub evidence는 전체 issue 목록 대신 대표 Project 캡처와 PR 흐름 설명으로 압축한다.
...
- [ ] PDF가 58페이지 예산 안에 들어가며, 최종 제출 제한 60페이지 미만을 유지한다.
